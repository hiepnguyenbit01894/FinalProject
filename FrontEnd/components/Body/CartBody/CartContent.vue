  ...
  <div class="cartContent">
    <div class="container container-v2 ">
      <div class="cartBody_nav">
        <a href="#!" title="Back to the Home">Home
                    ...
                    <tr v-for="item in cartItems" :key="item.id" class="cart-item">
                      ...
                      <td data-label="Quantity" class="product-quantity" data-title="Quantity">
                        <div class="input-group"><span class="input-group-btn minus">
                          <button @click=" addItem(item,'-')" type="button" class="btn btn-default">-</button>
                            </span><input type="text" step="1" max="10" :value="item.quantity"
                            name="quantity" class="quantity-field  text-center"
                            style="text-align: center;"><span class="input-group-btn plus">
                    ...
                    <table class="total-checkout">
                      <tbody>
                        <tr>
                          ...
                          <td class="cart-amount"><span><strong><span id="amountPrs">$ {{ totalPrice }}.00</span></strong> </span></td>
                        </tr>
                      </tbody>
                    </table>
                    <div class="proceed-to-checkout clearfix">
                      <a class="checkout-button button alt wc-forward bg-color" href="chekcout.html">Proceed to checkout</a>
                    </div>
                  </div>
                </div>
              </form>
    ...
    table {
      ...
      tbody {
        ...
        .cart-item {
          ...
          .product-name-thumb,.product-remove{
            a{
              color: black;
            }
          }
